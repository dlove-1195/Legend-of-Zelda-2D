...
namespace Sprint2
{
    public class DragonWalkRightDamageState : IEnemyState
    {
        private Dragon dragon;
        private Texture2D texture = Texture2DStorage.GetSpriteSheet();//nedd to fix later
        public DragonWalkRightDamageState(Dragon dragon)
        {
            if (dragon == null)
            {
            ...
            this.dragon = dragon;
            this.dragon.DragonSprite = new DragonDamageSprite(texture, this.dragon);//nedd to fix later
