...
namespace Sprint2
{
    public class KeyboardController : IController
    {
        ...
        public KeyboardController(Game1 game)
        {
            ...
            map.Add(Keys.D3, new Gear3(myGame));//bow
            map.Add(Keys.D4, new Gear4(myGame));//candle
            map.Add(Keys.D5, new Gear5(myGame));//arrow
            map.Add(Keys.D6, new Gear6(myGame));//Boomer
