...
namespace Sprint2
{
    public class WoodenSwordUp : ISprite
    {
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 vector)
        {
            ...
            Rectangle destinationRectangle = new Rectangle((int)vector.X , (int)vector.Y + currentPos, width * 3, height * 3);    // determine location and demension of the current frame
